...
void SimulationManager::BuildScenario()
{
    ...
    //////CAMERA & LIGHT//////
    OpenGLTrackball* trackb = new OpenGLTrackball(btVector3(0, 0, -500.f), 8000.f, btVector3(0,0,-1.f), 0, 0, SimulationApp::getApp()->getWindowWidth(), SimulationApp::getApp()->getWindowHeight(), 2, 60.f);
