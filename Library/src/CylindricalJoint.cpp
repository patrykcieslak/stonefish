...
CylindricalJoint::CylindricalJoint(std::string uniqueName, SolidEntity* solidA, SolidEntity* solidB, const btVector3& axis, bool collideLinkedEntities) : Joint(uniqueName, collideLinkedEntities)
{
...
void CylindricalJoint::Render()
{
    
}

btVector3 CylindricalJoint::getAxis()
{
