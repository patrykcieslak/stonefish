...
TorusEntity::TorusEntity(std::string uniqueName, btScalar torusMajorRadius, btScalar torusMinorRadius, bool isStatic, Material* mat, Look l) : SolidEntity(uniqueName, isStatic, mat)
{
