...
Profiler::Profiler(std::string uniqueName, btScalar angleRangeDeg, unsigned int angleSteps, btScalar frequency, int historyLength) : LinkSensor(uniqueName, frequency, historyLength)
{
...
{
    btTransform profTrans = getSensorFrame();
