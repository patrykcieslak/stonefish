...
#ifndef __Stonefish_OpenGLFLS2__
#define __Stonefish_OpenGLFLS2__
...
namespace sf
{
    ...
    class OpenGLFLS2 : public OpenGLView
    {
    public:
        //! A constructor.
        /*!
         ...
         */
        OpenGLFLS2(glm::vec3 eyePosition, glm::vec3 direction, glm::vec3 sonarUp,
    ...
    protected:
        ...
        GLuint inputRangeIntensity2Tex;
        GLuint inputDepthRBO;
        GLuint inputDepth2RBO;
        GLuint outputTex;
        GLuint outputFBO;
        GLuint displayTex;
        GLuint displayFBO;
