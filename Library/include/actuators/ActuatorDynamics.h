...
namespace sf
{
    ...
    enum class ThrustModelType {QUADRATIC, DEADBAND, INTERP, FD};
    ...
    public:
        ...
        /*!
          \param cb
        */
        QuadraticThrust(Scalar cb) : cb(cb)
        {
        }
        ...
        */
        ...
        {
            Scalar thrust = cb * input * btFabs(input);
    ...
    public:
        ...
        /*!
          ...
          \param dr
        */
        DeadbandThrust(Scalar cl, Scalar cr, Scalar dl, Scalar dr) : cl(cl), cr(cr), dl(dl), dr(dr)
        {
        }
    ...
    public:
        ...
        /*!
          ...
          \param RH flag informing if hte propeller is right-handed
        */
