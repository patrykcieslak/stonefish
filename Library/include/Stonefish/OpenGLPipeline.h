...
typedef enum {SOLID, SOLID_CS, HYDRO, HYDRO_CS, HYDRO_LINES, HYDRO_LINE_STRIP, SENSOR_CS, SENSOR_LINES, SENSOR_LINE_STRIP, SENSOR_POINTS, ACTUATOR_LINES} RenderableType;   
