...
{   
    ...
    public:
         ...
         */
        Gyroscope(const std::string& uniqueName, Scalar frequency = Scalar(-1), int historyLength = -1);
        ...
        */
        static std::unique_ptr<Gyroscope> Construct(const std::string& uniqueName, Scalar frequency, ConstructInfo& info);
