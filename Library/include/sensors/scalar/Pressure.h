...
namespace sf
{
    ...
    public:
         ...
         */
        Pressure(const std::string& uniqueName, Scalar frequency = Scalar(-1), int historyLength = -1);
        ...
        */
        static std::unique_ptr<Pressure> Construct(const std::string& uniqueName, Scalar frequency, ConstructInfo& info);
    };
}
