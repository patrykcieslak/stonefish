...
namespace sf
{
    ...
    public:
         ...
         */
        Accelerometer(const std::string& uniqueName, Scalar frequency = Scalar(-1), int historyLength = -1);
        ...
        */
        static std::unique_ptr<Accelerometer> Construct(const std::string& uniqueName, Scalar frequency, ConstructInfo& info);
    };
}
