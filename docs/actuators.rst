...
A push actuator is a virtual actuator that applies a given force to the attached body. It can also be used as a simplified thruster model.

.. code-block:: xml

    <actuator name="Push" type="push"> <!-- type="simple_thruster" to only enable when submerged -->
        <specs inverted="false" lower_limit="-10.0" upper_limit="10.0"/>
...
.. code-block:: xml
    ...
    <actuator name="Rudder" type="rudder">
        <specs lift_coeff="0.5" drag_coeff="0.1" max_angle="1.0" area="0.05" stall_angle="0.9" inverted="false"/>
        <visual>
...
.. code-block:: cpp
    ...
    sf::Rudder* rudder = new sf::Rudder("Rudder", rudderMesh, 0.05, 0.5, 0.1, 0.9, 1.0, false);        
