...
void JointsTestManager::BuildScenario()
{
    ...
    //----Fixed Joint----
    sf::Box* box = new sf::Box("Box", sf::Vector3(0.1,0.1,0.1), sf::I4(), getMaterialManager()->getMaterial("Plastic"), sf::BodyPhysicsType::SURFACE_BODY, green);
    AddSolidEntity(box, sf::Transform(sf::IQ(), sf::Vector3(-2.0,0.0,-3.0)));
    
    sf::Sphere* sph = new sf::Sphere("Sph1", sf::Scalar(0.2), sf::I4(), getMaterialManager()->getMaterial("Steel"), sf::BodyPhysicsType::SURFACE_BODY, orange);
    ...
    //----Revolute Joint----
    box = new sf::Box("Box", sf::Vector3(0.1,0.1,0.1), sf::I4(), getMaterialManager()->getMaterial("Plastic"), sf::BodyPhysicsType::SURFACE_BODY, green);
    AddSolidEntity(box, sf::Transform(sf::IQ(), sf::Vector3(0.5,0.0,-1.0)));
    
    sf::Box* box2 = new sf::Box("Box", sf::Vector3(0.1,0.1,0.1), sf::I4(), getMaterialManager()->getMaterial("Plastic"), sf::BodyPhysicsType::SURFACE_BODY, orange);
    ...
    sph = new sf::Sphere("Sph2", sf::Scalar(0.2), sf::I4(), getMaterialManager()->getMaterial("Plastic"), sf::BodyPhysicsType::SURFACE_BODY, green);
    ...
    //----Spherical Joint----
    sph = new sf::Sphere("Sph3", sf::Scalar(0.2), sf::I4(), getMaterialManager()->getMaterial("Plastic"), sf::BodyPhysicsType::SURFACE_BODY, green);
    AddSolidEntity(sph, sf::Transform(sf::IQ(), sf::Vector3(0.0, -2.0, -1.0)));
    sf::Sphere* sph2 = new sf::Sphere("Sph4", sf::Scalar(0.15), sf::I4(), getMaterialManager()->getMaterial("Plastic"), sf::BodyPhysicsType::SURFACE_BODY, orange);
    ...
    //----Prismatic Joint----
    box = new sf::Box("Box4", sf::Vector3(0.1,0.1,0.1), sf::I4(), getMaterialManager()->getMaterial("Plastic"), sf::BodyPhysicsType::SURFACE_BODY, green);
    AddSolidEntity(box, sf::Transform(sf::IQ(), sf::Vector3(1.0,0.0,-0.051)));
    
    box2 = new sf::Box("Box5", sf::Vector3(0.1,0.1,0.1), sf::I4(), getMaterialManager()->getMaterial("Plastic"), sf::BodyPhysicsType::SURFACE_BODY, orange);
    ...
    //----Cylindrical Joint----
    box = new sf::Box("Box6", sf::Vector3(0.1,0.1,0.1), sf::I4(), getMaterialManager()->getMaterial("Plastic"), sf::BodyPhysicsType::SURFACE_BODY, green);
    AddSolidEntity(box, sf::Transform(sf::IQ(), sf::Vector3(-1.0,0.0,-0.051)));
    
    box2 = new sf::Box("Box7", sf::Vector3(0.1,0.1,0.1), sf::I4(), getMaterialManager()->getMaterial("Plastic"), sf::BodyPhysicsType::SURFACE_BODY, orange);
    AddSolidEntity(box2, sf::Transform(sf::IQ(), sf::Vector3(-1.0,0.0,-0.5)));
